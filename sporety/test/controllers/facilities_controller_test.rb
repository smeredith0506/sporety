...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { fee: @facility.fee, game_types: @facility.game_types, hours: @facility.hours, location: @facility.location, membership: @facility.membership }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { fee: @facility.fee, game_types: @facility.game_types, hours: @facility.hours, location: @facility.location, membership: @facility.membership }
    assert_redirected_to facility_path(assigns(:facility))
  end
